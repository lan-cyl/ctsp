...
public class Individual implements Comparable<Individual> {
	...
	public Individual(int cityCount, Problem problem) {
		fitness = 1.0e10;
		cityChromo = new int[cityCount];
		salesmanChromo = new int[cityCount];
	}

	public Individual(int cityCount, Problem problem, boolean useGreedy) {
	 ...
	 * @param child2
	 */
	public void crossOver(Problem problem, Individual child2) {
		...
		for (int i = 0; i < len; i++) {
			...
			cityChromo[a] = child2.cityChromo[a];
		}
		// 处理重复值Chromo.length
		int end = (t + len - 1) % n;
	...
	public void swap(Individual ind2) {
